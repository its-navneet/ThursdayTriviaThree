...
class RestaurantList {
    fun getRestaurantList(): List<Restaurant>{
        return listOf<Restaurant>(
            Restaurant(R.drawable.res1,R.string.resName1,R.string.resDes1,R.string.resRate1,R.string.resPrice1),
            Restaurant(R.drawable.res2,R.string.resName2,R.string.resDes2,R.string.resRate2,R.string.resPrice2),
            Restaurant(R.drawable.res3,R.string.resName3,R.string.resDes3,R.string.resRate3,R.string.resPrice3),
            ...
            Restaurant(R.drawable.res6,R.string.resName6,R.string.resDes6,R.string.resRate6,R.string.resPrice6),
